...
public class Info_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.info_activity);
		 ...
		 this.donationButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				
				String url_donation = "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=FJDAFTPKN2S2W";
	            
				Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(url_donation));
